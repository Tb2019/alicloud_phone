...
class Sample:
    ...
    def main(
        ...
        assign_jobs_request = outbound_bot_20191226_models.AssignJobsRequest(
            job_group_id='f55f1e75-5756-4255-94a8-ee04c162632a',
            instance_id='3f4c4489-ff70-46cf-acf0-ead5d2545dfe',
            job_data_parsing_task_id='',
            is_asynchrony=False,
            calling_number=[
                '20240524'
            ],
    ...
    "contacts":[
        ...
        try:
            ...
            client.assign_jobs_with_options(assign_jobs_request, runtime)
